class OrderDetailsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @order_detail.save
        format.html { redirect_to order_order_details_url(@order_details), notice: "Order detail was successfully created." }
  ...
  private
    ...
    def order_detail_params
      params.require(:order_detail).permit(:quantity, :price_per_item, :order_id, :menu_item_id)
    end
end
